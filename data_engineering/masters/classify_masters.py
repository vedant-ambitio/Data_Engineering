"""
Unified 3-Tier Classification for Masters files.

Classifies each Masters .md file by verifying 3 sections against crawled official data:
  1. Tuition & Fees
...
MASTERS_MD_DIR = BASE_DIR / "masters_data" / "masters"
OFFICIAL_DIR = BASE_DIR / "official_urls"
SECTION_URLS_FILE = OFFICIAL_DIR / "masters_section_urls.json"
INDEX_FILE = OFFICIAL_DIR / "crawled_data" / "url_index.json"
PAGES_DIR = OFFICIAL_DIR / "crawled_data" / "pages"

OUTPUT_DIR = BASE_DIR / "classification_results" / "masters"
...
def main():
    ...
    for college, files in section_urls.items():
        for fname, fdata in files.items():
            tasks.append((college, fname, fdata, url_index, str(MASTERS_MD_DIR)))
